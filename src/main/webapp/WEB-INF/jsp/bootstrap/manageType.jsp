...
<div class="container">
	<div class="form-group">
		<div class="panel panel-Primary">
		  <div class="panel-heading"><lable class="headPanal">Manage Type</lable>
		 ...
		 <div class="panel-body" style="margin-top:-25px;">
		  <div class="row">
				...
				<div class="row" style="margin-top:10px; margin-bottom:-5px" name="addEditData">
					...
					<div class="col-md-3">
					<label for="InputName1">Type Code</label>
						<input type="text" class="form-control" placeholder="Type Code" name="typeCode" disabled>
					</div>
					<div class="col-md-3">
					<label for="InputName1">Type Name</label>
						<input type="text" class="form-control" placeholder="Type Name" name="typeName" disabled>
					</div>
				</div>
