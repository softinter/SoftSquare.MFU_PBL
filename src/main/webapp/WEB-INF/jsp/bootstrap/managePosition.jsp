...
<div class="container">
	<div class="form-group">
		<div class="panel panel-Primary">
		  <div class="panel-heading"><lable class="headPanal">Manage Position</lable>
		 ...
		 <div class="panel-body" style="margin-top:-25px;">
		  <div class="row">
				...
				<div class="row" style="margin-top:10px; margin-bottom:-5px" name="addEditData">
					...
					<div class="col-md-3">
					<label for="InputName1">Position Code</label>
						<input type="text" class="form-control" placeholder="Position Code" name="positionCode" disabled>
					</div>
					<div class="col-md-3">
					<label for="InputName1">Position Name</label>
						<input type="text" class="form-control" placeholder="Position Name" name="positionName" disabled>
					</div>
					<div class="col-md-3">
					<label for="InputName1">Position Detail</label>
						<input type="text" class="form-control" placeholder="Position Detail" name="positionDetail" disabled>
					</div>
		        ...
		        <div class="panel panel-primary filterable">
		            ...
		            <table class="table">
		                <thead>
		                    <tr class="filters">
		                    	<th>Manage</th>
		                        <th><input type="text" class="form-control" placeholder="Position Code" disabled></th>
		                        <th><input type="text" class="form-control" placeholder="Position Name" disabled></th>
		                        <th><input type="text" class="form-control" placeholder="Position Detail" disabled></th>
