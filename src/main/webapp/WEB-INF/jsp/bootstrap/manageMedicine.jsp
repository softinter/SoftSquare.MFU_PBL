...
<div class="container">
	<div class="form-group">
		<div class="panel panel-primary ">
		  <div class="panel-heading"><lable class="headPanal">Manage Medicine</lable>
				<div class="row" id="typeHeader">
					<div class="col-md-2"></div>
					<div class="col-md-4">
						<label class="control-label-required">Type</label>
						<select class="selectpicker show-tick show-menu-arrow"  name="typeList" data-live-search="true" data-size="5" data-header="Select Type" ></select>
					</div>
		 ...
		 <div class="panel-body" style="margin-top:-25px;">
		  <div class="row">
		 		<button type="button" class="btn btn-primary " onclick="addRow()">
					<span class="glyphicon glyphicon-plus"></span>New Medicine
				</button> 
				...
				<div class="row" style="margin-top:10px; margin-bottom:-5px" name="addEditData">
					<div class="col-md-3">
					<label for="InputName1">Medicine Name</label>
						<input type="text" class="form-control" placeholder="Medicine Name" name="medicineName" disabled>
					</div>
					<div class="col-md-3">
					<label for="InputName1">Medicine Cost</label>
						<input type="number" class="form-control" placeholder="Medicine Cost" name="medicineCost" disabled>
					</div>
					
					<div class="col-md-3">
					<label for="InputName1">Medicine Type</label>
						<select class="selectpicker show-tick show-menu-arrow"  name="typeList" data-live-search="true" data-size="5" data-header="Select Type" disabled></select>
					</div>
		            ...
		            <table class="table">
		                <thead>
		                    <tr class="filters">
		                        ...
		                        <th><input type="text" class="form-control" placeholder="Medicine Cost" disabled></th>
